...
export default function FamilyDeluxe() {
    return (
        <>
            <Hero hero='roomsHero'>
                <Banner title="Family Deluxe">
                </Banner>
            </Hero>
            <div className='single-room'>
                <div className="single-room-images">
                    <img src={img2} alt="family deluxe"/>
                    <img src={img3} alt="family deluxe"/>
                    <img src={img4} alt="family deluxe"/>
                </div>
